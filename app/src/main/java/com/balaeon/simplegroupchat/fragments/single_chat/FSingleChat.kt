...
import com.balaeon.simplegroupchat.databinding.FSingleChatBinding
import com.balaeon.simplegroupchat.db.data.*
import com.balaeon.simplegroupchat.fragments.FAttachment
import com.balaeon.simplegroupchat.models.MyImage
import com.balaeon.simplegroupchat.models.UserProfile
import com.balaeon.simplegroupchat.utils.*
import com.balaeon.simplegroupchat.utils.Events.EventAudioMsg
import com.balaeon.simplegroupchat.utils.Utils.edtValue
import com.balaeon.simplegroupchat.views.CustomEditText
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            viewModel.getMessagesByChatUserId(chatUserId).collect { mMessagesList ->
                Log.d("getMessagesByChatUserId","${mMessagesList.size}")
